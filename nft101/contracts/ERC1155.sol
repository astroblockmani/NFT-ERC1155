...
contract ERC1155 {
    ...
    function safeTransferFrom(address from, address to, uint256 id, uint256 amount) public virtual {
        ...
        require(_checkOnERC1155Received(), "Receiever is not implemented");
    }

    // Oversimplified verison
    ...
    function safeBatchTransferFrom(address from, address to, uint256[] memory ids, uint256[] memory amounts) public {
        ...
        require(_checkOnBatchERC1155Received(), "Receiever is not implemented");
    }
    ...
    // ERC165 Compliant. Tell everyone that we support the ERC1155 functions
